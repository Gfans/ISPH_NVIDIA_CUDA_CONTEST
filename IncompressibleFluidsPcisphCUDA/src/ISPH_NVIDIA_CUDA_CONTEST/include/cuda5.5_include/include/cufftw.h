...
void CUFFTAPI fftw_execute(fftw_plan plan);

void CUFFTAPI fftw_execute_dft(fftw_plan plan, 
                               fftw_complex *idata,
                               fftw_complex *odata);

void CUFFTAPI fftw_execute_dft_r2c(fftw_plan plan, 
                                   double *idata,
                                   fftw_complex *odata);

void CUFFTAPI fftw_execute_dft_c2r(fftw_plan plan, 
                                   fftw_complex *idata,
                                   double *odata);
...
void CUFFTAPI fftwf_execute(fftw_plan plan);

void CUFFTAPI fftwf_execute_dft(fftwf_plan plan, 
                                fftwf_complex *idata,
                                fftwf_complex *odata);

void CUFFTAPI fftwf_execute_dft_r2c(fftwf_plan plan, 
                                    float *idata,
                                    fftwf_complex *odata);

void CUFFTAPI fftwf_execute_dft_c2r(fftwf_plan plan, 
                                    fftwf_complex *idata,
                                    float *odata);
...
void CUFFTAPI fftw_print_plan(fftw_plan plan);                                 

void CUFFTAPI fftwf_print_plan(fftwf_plan plan); 
